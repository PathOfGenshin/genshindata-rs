...
pub enum Type {
    ...
    QuestCondActivityGcgPveHardRefresh,
    #[serde(rename = "QUEST_COND_ACTIVITY_GCG_PVE_HARD_REWARD_CAN_TAKE")]
    QuestCondActivityGcgPveHardRewardCanTake,
    #[serde(rename = "QUEST_COND_ACTIVITY_GCG_PVE_INFINITE_REFRESH")]
...
pub enum TalkMarkType {
    #[serde(rename = "TALK_MARK_BILLBOARD_ONLY")]
    TalkMarkBillboardOnly,
