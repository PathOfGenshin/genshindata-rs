...
pub struct PushTipsConfigDatum {
    ...
    #[serde(rename = "EMAOJBKGIIF")]
    pub emaojbkgiif: Option<bool>,
    #[serde(rename = "NHDGMNLCIJG")]
    pub nhdgmnlcijg: Option<bool>,
    #[serde(rename = "ILLNDIEEEPN")]
    pub illndieeepn: Option<bool>,
}
