...
pub struct PushTipsConfigDatum {
    ...
    #[serde(rename = "GBNKGCFNBIK")]
    pub gbnkgcfnbik: Option<bool>,

    #[serde(rename = "NAENENDIEOC")]
    pub naenendieoc: Option<bool>,

    #[serde(rename = "JHBGPHOLMCN")]
    pub jhbgpholmcn: Option<bool>,
}
