...
pub struct TreasureMapRegionExcelConfigDatum {
    ...
    #[serde(rename = "ECDMPGDINFD")]
    pub ecdmpgdinfd: Vec<f64>,

    #[serde(rename = "CFLKPEKFOCD")]
    pub cflkpekfocd: i64,

    #[serde(rename = "JJOMLBKCOCK")]
    pub jjomlbkcock: Option<i64>,
    ...
    #[serde(rename = "DEFFIKGDHOL")]
    pub deffikgdhol: Option<i64>,
}
